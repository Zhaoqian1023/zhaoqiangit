...
<head>
	<title>部门设置</title>
	<%@include file="/WEB-INF/page/public/head.jsp" %>
</head>
<body>
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%=basePath%>style/images/title_arrow.gif"/> 部门信息
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="department_%{id==null?'add':'edit'}"  method="post">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">上级部门</td>
                        <td>
                            <s:select name="parentId" cssClass="SelectStyle" list="departmentList" listKey="id" listValue="name" headerKey="" headerValue="请选择部门"></s:select>
                        </td>
                    </tr>
                    <tr><td>部门名称</td>
                        <td>
